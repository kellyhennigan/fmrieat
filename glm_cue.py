...
data_dir = os.path.join('/home','span','lvta','fmrieat','derivatives')
...
#-#-#-#-#-#-#-#-#-#-#-		Run 3dDeconvolve:		-#-#-#-#-#-#-#-#-#-#-#
	...
	cmd = ('3dDeconvolve '		
		...
		'-stim_file 12 regs/alcohol_trialc.1D -stim_label 12 alcohol ' 
		'-stim_file 13 regs/drugs_trialc.1D -stim_label 13 drugs ' 
		'-stim_file 14 regs/food_trialc.1D -stim_label 14 food ' 
		'-stim_file 15 regs/neutral_trialc.1D -stim_label 15 neutral ' 

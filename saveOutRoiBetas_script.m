...
resultsDir = fullfile(dataDir,['results_' task ]);
% resultsDir = fullfile(dataDir,['results_' task '_afni_reltest']);
% resultsDir = fullfile(dataDir,['results_' task '_pref']);
...
% bNames = {'pref'}; % bNames should correspond to volumes in index volIdx

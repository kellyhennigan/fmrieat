...
p.source='/home/span/lvta/fmrieat/source';
% p.derivatives=


p.scripts='/home/span/lvta/fmrieat/scripts';
path(p.scripts,path)

dataDir = '/home/span/lvta/fmrieat/derivatives';

figDir = fullfile('/home/span/lvta/fmrieat/figures','QA',task);
